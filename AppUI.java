...
public class AppUI {
	...
	public void getCredentials(){
		...
		url.setColumns(4);
		  ...
		  final JLabel jobLabel = new JLabel("JOB Name :"); jobLabel.setBounds(90, 170,
		  200, 26); jFrame.getContentPane().add(jobLabel); final JTextField job = new
		  JTextField(); job.setBounds(177, 170, 133, 26);
		  jFrame.getContentPane().add(job); job.setColumns(4);
		...
		Tasks1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if((String) Tasks1.getSelectedItem()=="Create Job"){
					...
					attributesWindow.setAlias(aliasTextField.getText());
					attributesWindow.setPasswd(new String(passwdTextField.getPassword()));
					attributesWindow.setSiteURL(url.getText());
				...
				}else if((String) Tasks1.getSelectedItem()=="Build Job"){
		...
		runButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//	System.out.println(job.setXmlFilePath(select.getConfigfilepath()));
					job.setToken(passwd);
				...
				else if (selected.equals("Build Job")){
					System.out.println("Selected: " + selected);
					JenkinsJob job = new JenkinsJob();
					job.setXmlFilePath(select.getConfigfilepath());
					//	System.out.println(job.setXmlFilePath(select.getConfigfilepath()));
						...
						job.setJobname(jobname);
					//String credentials = Authenticator.getAuthToken(job.getUsername(), job.getToken());
					HttpConnect.buildJob(url.getText(), job);
					System.out.println("done: " + selected);
			}
		}
